...
import { ArrowLeft, Save, X, Download, Upload, Plus } from "lucide-react"
                        ...
                        <div className="mb-6">
                                            ...
                                            <tr key={index} className="border-b border-dashed border-gray-200 group hover:bg-gray-50/50">
                                                <td className="py-2 px-4">
                                                    <Input
                                                        ...
                                                        className={`border-0 focus:ring-0 focus:border-b focus:border-blue-500 rounded-none px-0 h-9 text-sm w-full bg-transparent ${index === quoteData.items.length - 1 ? 'text-red-500 italic' : ''}`}
                                                    />
                                                </td>
                                                <td className="py-2 px-4">
                            ...
                            <div className="flex gap-2 mt-4">
                                <Button
                                    ...
                                    variant="outline"
                                    onClick={addItem}
                                    className="border-blue-200 text-green-600 hover:bg-green-50 hover:text-green-700 hover:border-green-300 font-medium"
                                >
                                    <span className="mr-2 font-bold text-lg">+</span> {t("quotes.upsert.form.items.addItem") || "Ligne simple"}
                                </Button>
                                <Button
                                    type="button"
                                    variant="outline"
